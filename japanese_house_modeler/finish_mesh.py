...
def custom_polygon_should_be_smooth(profile, coordinates, horizontal_sign,
    ...
    height/length signature.  Requiring both matches keeps caps (including
    ...
    for index in indices:
        ...
        expected = ((first[1] - profile_minimum_y,
                     second[1] - profile_minimum_y),
...
def apply_profile_shading(mesh, profile, horizontal_sign=1.0):
    ...
    for polygon in mesh.polygons:
        if custom:
            ...
            polygon.use_smooth = custom_polygon_should_be_smooth(
                profile, coordinates, horizontal_sign, minimum_z)
        else:
